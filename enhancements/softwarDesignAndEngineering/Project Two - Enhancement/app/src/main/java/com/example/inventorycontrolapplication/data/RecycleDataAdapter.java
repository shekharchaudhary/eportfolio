...
public class RecycleDataAdapter extends RecyclerView.Adapter<RecycleDataAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            ...
            editButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    EditButtonOnClick(view, itemId.getText().toString(),
    ...
    private void EditButtonOnClick(View view, String id, String name, String type, String count)
    {
        // Navigate to edit item fragment with all item details
        HomeFragmentDirections.ActionHomeToEditItem action =
            HomeFragmentDirections.actionHomeToEditItem(id, name, type, count);
        Navigation.findNavController(view).navigate(action);
    }
